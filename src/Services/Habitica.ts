    ...
    async webhookHandler(data: any){
        return new Promise(async(resolve,reject)=>{
            ...
            if(data.type == "scored" || data.type == "updated" || data.type == "checklistScored"){
                if(data.task.id != "b322a291-87c4-490e-8bf6-2b7087538929" && data.task.id != "4239c5ca-490e-4b99-b8ad-46857f6ba80b" ){
                ...
                if(data.task.id == "4239c5ca-490e-4b99-b8ad-46857f6ba80b"){
                    const sleepStatus = await habiAPI.get('/user',{
                        headers: {
                            'x-api-user': 'c150cf43-bf4a-4c46-8912-9c04f77d3924',
                            'x-api-key': '3a00e702-525c-41f2-a69a-d10b741b0c5c',
                            'x-client': 'c150cf43-bf4a-4c46-8912-9c04f77d3924-cordeiroAPI'
                    ...
                    if(!sleepStatus){
                        await habiAPI.post('/user/sleep',{},{
                            ...
                            .then(async (response)=>{
                                await discord.send_message('habitica_news',"Got it. Take a rest sir. See you tomorrow.",{
                                    username: "Grifo",
                                    avatar_url: "https://habitica.com/static/img/melior@3x.fe3b187f.png"
                                })
                                .then(response=>{
                        ...
                        await discord.send_message('habitica_news',"You're already sleeping my friend! You just spent your money, you fool!",{
                            username: "Grifo",
                            avatar_url: "https://habitica.com/static/img/melior@3x.fe3b187f.png"
                        })
                        .then(response=>{
