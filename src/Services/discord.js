...
exports.default = {
    helloMessage: function (req, res) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, api_1.default.post(testes_do_cordeiro, {
    ...
    sendMessage: function (channel, template) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        if (channel == 'todo')
                            channel = todo;
                        return [4 /*yield*/, api_1.default.post(channel, {
                                "content": "" + template,
                                "username": "Lord Darth Vader",
                                "avatar_url": "https://rodcordeiro.github.io/shares/img/vader.png"
                            })
    ...
    habiticaMessage: function (req, res) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, api_1.default.post(testes_do_cordeiro, {
