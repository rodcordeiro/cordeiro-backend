...
function verifyBoard(boardId) {
  if (
    boardId == '5e68d2962d3d5a363a47dbe8' ||
    boardId == '5ec5586bf2afe861f95ac78e'
  ) {
    //Akta || RodrigoController
    return 'testes_do_cordeiro';
  }
  if (boardId == '5e979a60c03d201feb94a375') {
    //ICNT
    return 'icnt';
  }
  if (boardId == '5ee6d3ef4ff13f18e980b150') {
    //DeathStar
    return 'todo';
  }
  return 'testes_do_cordeiro';
